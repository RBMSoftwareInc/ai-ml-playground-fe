  ...
  return (
    <Paper
      sx={{
        p: 3,
        borderRadius: 3,
        backgroundColor: isFraud ? 'rgba(244,67,54,0.08)' : 'rgba(107,114,128,0.08)',
        border: `1px solid ${isFraud ? 'rgba(244,67,54,0.4)' : 'rgba(107,114,128,0.4)'}`,
        minHeight: 160,
      }}
    >
      <Typography variant="h5" sx={{ fontWeight: 700, color: isFraud ? '#f44336' : '#6b7280' }}>
