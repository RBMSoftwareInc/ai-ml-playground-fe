...
import FraudPage from '../app/fruad/page';
import OrderDelayForecastPage from '../app/delay/page';
import InventoryReorderPage from '../app/inventory/page';
import NLPSearchPage from '../app/nlp/page';
import BundleAndOutfitPage from '../app/bundle/page';
import PersonalizationPage from '../app/personalization/page';
import AIChatAssistantPage from '../app/chat/page';
import VoiceSearchPage from '../app/voice/page';
import DynamicPricingPage from '../app/pricing/page';
import CouponAbusePage from '../app/coupon/page';
import ChurnPredictionPage from '../app/churn/page';
import SegmentationPage from '../app/segmentation/page';
import SubjectLinePage from '../app/subject/page';
import LeadGenPage from '../app/leadgen/page';
import AutoCategorizationPage from '../app/categorization/page';
import ReviewSentimentPage from '../app/sentiment/page';
import TitleDescriptionPage from '../app/descriptions/page';
import AITryOnPage from '../app/tryon/page';
